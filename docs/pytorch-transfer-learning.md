...
| Dataset   |  Classes | Size  | Training Images | Time per Epoch* | Training Time** |
|-----------|----------|-------|-----------------|-----------------|-----------------|
| [`Cat/Dog`](pytorch-cat-dog.md)   |    2    | 800MB |      5,000      |  ~7-8 minutes   |    ~4 hours     |
| [`PlantCLEF`](pytorch-plants.md) |   20    | 1.5GB |     10,475      | ~15 minutes     |    ~8 hours     |
