...
- `--network` flag setting the classification model (default is GoogleNet)
	- See [Downloading Other Classification Models](imagenet-console-2.md#downloading-other-classification-models) for the networks available to use.<br/>
- `--camera` flag setting the camera device to use
	...
	- The default is to use MIPI CSI sensor 0 (`--camera=0`)<br/>
