...
> &gt; &nbsp; See our latest technical blog including benchmarks, [`https://devblogs.nvidia.com/bringing-cloud-native-agility-to-edge-ai-with-jetson-xavier-nx`](Bringing Cloud-Native Agility to Edge AI Devices with the NVIDIA Jetson Xavier NX Developer Kit). <br/>
...
**Training GPU:**  Maxwell, Pascal, Volta, Turing, or Ampere-based GPU (ideally with at least 6GB video memory)  
