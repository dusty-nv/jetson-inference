...
During this tutorial, you'll learn to deploy efficient neural networks using NVIDIA [GPU Inference Engine](https://developer.nvidia.com/gpu-inference-engine) and stream from live camera feed for performing realtime recogntion with AlexNet / GoogLeNet.
